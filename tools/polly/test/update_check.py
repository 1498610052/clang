...
polly_src_dir = '''/root/tc-build/llvm-project/polly'''
polly_lib_dir = '''/root/tc-build/build/llvm/stage1/lib'''
shlibext = '''.so'''
llvm_tools_dir = '''/root/tc-build/build/llvm/stage1/./bin'''
llvm_polly_link_into_tools = not '''ON'''.lower() in {'','0','n','no','off','false','notfound','llvm_polly_link_into_tools-notfound'}
