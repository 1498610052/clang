# Autogenerated from /root/tc-build/llvm-project/clang/test/Unit/lit.site.cfg.py.in
# Do not edit!
...
lit_config.load_config(
    config, os.path.join(path(r"/root/tc-build/llvm-project/clang"), "test/Unit/lit.cfg.py"))
