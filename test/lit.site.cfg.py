# Autogenerated from /root/tc-build/llvm-project/llvm/test/lit.site.cfg.py.in
# Do not edit!
...
config.targets_to_build = " ARM AArch64 X86"
config.native_target = "X86"
config.llvm_bindings = "".split(' ')
config.host_os = "Linux"
config.host_cc = "/usr/lib/llvm-10/bin/clang "
config.host_cxx = "/usr/lib/llvm-10/bin/clang++ "
# Note: ldflags can contain double-quoted paths, so must use single quotes here.
config.host_ldflags = ' -fuse-ld=/usr/lib/llvm-10/bin/ld.lld -Wl,--color-diagnostics -fexperimental-new-pass-manager -flto=thin -Wl,-allow-shlib-undefined'
